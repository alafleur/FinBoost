          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className={`bg-white rounded-xl border border-slate-300 hover:border-blue-300 ${item.borderColor} border-l-4 p-6 hover:shadow-md transition-all duration-300 space-y-2`}
              >
