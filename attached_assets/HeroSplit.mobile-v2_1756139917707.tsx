    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="pt-24 md:pt-28 lg:pt-32 pb-8 md:pb-10">
          ...
          <div className="lg:hidden relative px-4 pt-2 pb-40 min-h-[560px]">
            {/* Headline top-left */}
            ...
            <div className="absolute right-1 bottom-28 text-right max-w-[16ch] z-0">
            ...
            <div className="pointer-events-none absolute bottom-0 right-0 w-[78%] max-w-[340px] rotate-[8deg] drop-shadow-2xl z-10">
              <img
