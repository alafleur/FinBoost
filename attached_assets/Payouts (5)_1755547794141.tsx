...
interface RewardsResponse {
  summary: { paidTotalCents: number; pendingTotalCents: number; rewardsReceived: number };
  items: RewardItem[];
}
...
export default function Payouts() {
  ...
  const paidTotal = history?.summary.paidTotalCents ?? 0;
  const pendingTotal = history?.summary.pendingTotalCents ?? 0;
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{dollars(paidTotal)}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{dollars(pendingTotal)}</div>
