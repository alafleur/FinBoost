    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="pt-24 md:pt-28 lg:pt-32 pb-8 md:pb-10">
          ...
          <div className="lg:hidden relative px-4 pt-2 pb-44 min-h-[600px]">
            {/* Headline top-left */}
            ...
            <div className="absolute right-2 bottom-24 text-right max-w-[16ch] z-20">
            ...
            <div className="pointer-events-none absolute bottom-0 right-0 w-[74%] max-w-[330px] rotate-[8deg] drop-shadow-2xl z-10">
              <img
