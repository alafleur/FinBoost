    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="pt-24 md:pt-28 lg:pt-32 pb-8 md:pb-10">
          ...
          <div className="lg:hidden relative px-4 pt-2 pb-44 min-h-[640px]">
            {/* Headline top-left */}
            <div className="max-w-[22rem] text-left space-y-3 relative z-10">
              <h1 className="font-extrabold tracking-tight leading-[1.05] text-[clamp(1.7rem,6vw,3rem)]">
            ...
            <div className="absolute right-4 bottom-10 text-right max-w-[16ch] z-30">
              <h2 className="font-extrabold tracking-tight leading-[1.02] text-[clamp(1.7rem,6vw,3rem)] text-slate-900">
                <span className="block">Earn</span>
                <span className="block">Real Cash</span>
              </h2>
            </div>

            {/* Angled screenshot bridging the two headlines */}
            <div className="pointer-events-none absolute bottom-16 right-6 w-[68%] max-w-[320px] rotate-[8deg] drop-shadow-2xl z-10">
              <img
                className="w-full h-auto rounded-[24px] shadow-xl shadow-slate-900/15 ring-1 ring-gray-200/50"
                srcSet={`${step4_m240} 240w, ${step4_m480} 480w, ${step4_s304} 304w, ${step4_s608} 608w`}
                sizes="(max-width: 640px) 68vw, 304px"
                src={step4_m480}
                alt="FinBoost winner notification - $325 cash reward"
                loading="eager"
                decoding="async"
